/**
 * Simplified Chinese (converted from Traditional copy) Common Messages
 * 
...
export const common = {
  ...
  validation: {
    required: '此欄位為必填',
    invalidEmail: '请输入有效的電子郵件地址',
    invalidPhone: '请输入有效的電話號碼',
    invalidUrl: '请输入有效的網址',
    minLength: '至少需要 {min} 個字元',
    maxLength: '不可超過 {max} 個字元',
  ...
  errors: {
    ...
    cartUnavailable: '無法載入购物车組件',
    productsUnavailable: '無法載入商品組件',
    checkoutUnavailable: '無法載入结算組件',
    validation: '驗證錯誤',
    tryAgain: '请重试',
    error: '錯誤',
  },
  ...
  pagination: {
    ...
    of: '/',
    itemsPerPage: '每頁項目數',
    showingItems: '顯示第 {from} 至 {to} 項，共 {total} 項',
    firstPage: '第一頁',
    lastPage: '最後一頁',
    previousPage: '上一頁',
    nextPage: '下一頁',

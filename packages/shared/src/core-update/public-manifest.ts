...
export const PUBLIC_CORE_UPDATE_MANIFEST: PublicCoreUpdateManifest = {
  ...
  releaseDate: '2026-04-16T18:05:57.003Z',
  ...
  releaseNotes:
    'Publishes the 1.0.14 OSS patch release after validating the hardened self-hosted updater chain and aligning the public manifest route test with the canonical release manifest.',
  checksumUrl: null,
  signatureUrl: null,
};

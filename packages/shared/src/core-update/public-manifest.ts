...
export const PUBLIC_CORE_UPDATE_MANIFEST: PublicCoreUpdateManifest = {
  ...
  latestStableVersion: '1.0.99',
  latestPrereleaseVersion: null,
  channel: 'stable',
  deliveryMode: 'image-first',
  images: {
    api: 'crpi-si4hvlqhabu9zjq7.ap-southeast-1.personal.cr.aliyuncs.com/jiffoo-oss/api:1.0.99',
    admin: 'crpi-si4hvlqhabu9zjq7.ap-southeast-1.personal.cr.aliyuncs.com/jiffoo-oss/admin:1.0.99',
    shop: 'crpi-si4hvlqhabu9zjq7.ap-southeast-1.personal.cr.aliyuncs.com/jiffoo-oss/shop:1.0.99',
    updater: 'crpi-si4hvlqhabu9zjq7.ap-southeast-1.personal.cr.aliyuncs.com/jiffoo-oss/updater:1.0.99',
  },
  releaseDate: '2026-08-12T07:09:01.934Z',
  changelogUrl: 'https://github.com/thefreelight/Jiffoo/releases/tag/v1.0.99-opensource',
  sourceArchiveUrl: 'https://get.jiffoo.com/jiffoo-source.tar.gz',
  minimumCompatibleVersion: '1.0.0',
  minimumAutoUpgradableVersion: '1.0.0',
  requiresManualIntervention: false,
  releaseNotes:
    'Corrects the Cloudflare Native Wallet Checkout migration to unique schema version 0039.',
  checksumUrl: null,
  signatureUrl: null,
};

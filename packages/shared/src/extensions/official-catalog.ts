...
export const OFFICIAL_LAUNCH_EXTENSIONS: OfficialCatalogEntry[] = [
  ...
  },
  {
    ...
    artifactKind: 'theme-package',
    launchWave: 'official-extensions-go-live-v1',
    packageUrl: 'https://market.jiffoo.com/artifacts/themes/bokmoo/1.1.4.jtheme',
    minCoreVersion: '0.2.0',
    defaultPricingModel: 'free',
    defaultCurrency: 'USD',
    pricingConfigured: false,
  ...
  },
  {
    ...
    version: '0.0.1',
    author: 'Jiffoo',
    description: 'Private Agentra campaign execution bridge with tenant isolation, controlled job templates, and normalized lead ingestion.',
    deliveryMode: 'package-managed',
    paymentMode: 'platform_collect',
    settlementTargetType: 'platform',
    settlementTargetId: 'platform:jiffoo',
    artifactKind: 'plugin-package',
    launchWave: 'official-extensions-go-live-v1',
    packageUrl: 'https://market.jiffoo.com/artifacts/plugins/hermes-bridge/0.0.1.jplugin',
    minCoreVersion: '0.2.0',
    defaultPricingModel: 'free',
    defaultCurrency: 'USD',
  ...
  },
  {
    ...
    version: '0.1.1',
    author: 'Jiffoo',
    description: 'Official virtual credit ledger with authenticated balance, atomic credit and debit operations, and idempotent usage settlement.',
    deliveryMode: 'package-managed',
    paymentMode: 'platform_collect',
    settlementTargetType: 'platform',
    settlementTargetId: 'platform:jiffoo',
    artifactKind: 'plugin-package',
    launchWave: 'official-extensions-go-live-v1',
    packageUrl: 'https://market.jiffoo.com/artifacts/plugins/wallet/0.1.1.jplugin',
    minCoreVersion: '0.2.0',
    defaultPricingModel: 'free',
    defaultCurrency: 'USD',
    pricingConfigured: true,
  },
  {
    ...
    version: '0.0.2',
    author: 'Jiffoo',
    description: 'Official SMTP delivery plugin for transactional and campaign email with delivery logging and webhook support.',
    deliveryMode: 'package-managed',
    paymentMode: 'platform_collect',
    settlementTargetType: 'platform',
    settlementTargetId: 'platform:jiffoo',
    artifactKind: 'plugin-package',
    launchWave: 'official-extensions-go-live-v1',
    packageUrl: 'https://market.jiffoo.com/artifacts/plugins/smtp-email/0.0.2.jplugin',
    minCoreVersion: '0.2.0',
    defaultPricingModel: 'free',
    defaultCurrency: 'USD',
    pricingConfigured: true,

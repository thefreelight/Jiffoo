  ...
  return (
    <div className="min-h-screen bg-[var(--bokmoo-bg)] px-4 pb-24 pt-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[980px]">
        <div className="overflow-hidden rounded-[1.6rem] border border-[var(--bokmoo-line)] bg-[linear-gradient(180deg,color-mix(in_oklab,var(--bokmoo-bg-elevated)_96%,white),var(--bokmoo-bg-elevated))] shadow-[var(--bokmoo-shadow)]">
          <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[minmax(0,1fr)_20rem]">
            <div>
              ...
              <a
                ...
                className="mt-6 inline-flex min-h-11 items-center justify-center rounded-[0.9rem] border border-[var(--bokmoo-line)] px-5 text-sm font-medium text-[var(--bokmoo-ink)]"
              >
                {site.supportEmail}
              </a>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={label}
                    className="rounded-[1rem] border border-[var(--bokmoo-line)] bg-[var(--bokmoo-bg)] px-4 py-5"
                  >
            ...
            <div className="relative min-h-[19rem] overflow-hidden rounded-[1.4rem] border border-[var(--bokmoo-line)] bg-[linear-gradient(160deg,#30261c_0%,#141210_56%,#0a0a0b_100%)]">

      ...
      <div className="mx-auto max-w-[980px]">
        <section className="rounded-[var(--vault-radius-lg)] border border-[var(--vault-line)] bg-[var(--vault-surface)] p-6 text-center shadow-[var(--vault-shadow)] sm:p-10">
          ...
          <h1 className="mt-4 text-[clamp(2.4rem,5vw,4.8rem)] font-black leading-[0.94] tracking-[-0.05em] text-[var(--vault-ink)]">
            {isVerifying ? 'Finalizing your delivery locker.' : 'Your digital order is ready to unlock.'}
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[var(--vault-copy)]">
            {isVerifying
              ? 'The storefront is confirming payment and checking whether any fulfillment artifacts are already available.'
              : 'Access details are attached to the order as soon as the merchant or plugin finishes fulfillment. If delivery is instant, you may already see claim data below.'}
          </p>
                ...
                >
                  ...
                  {fields.length ? (
                    ...
                    <div className="mt-5 rounded-[var(--vault-radius-md)] border border-dashed border-[var(--vault-line)] bg-[var(--vault-bg)] p-4 text-sm text-[var(--vault-copy)]">
                      Fulfillment is still syncing. Open the order archive to refresh and view the complete delivery panel.
                    </div>
                  )}
                </article>
              );

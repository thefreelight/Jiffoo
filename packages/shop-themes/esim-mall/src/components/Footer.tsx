    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-lg font-semibold mb-4">TravelPass</h3>
            <p className="text-gray-400 mb-4">
              {getText(t, 'travelpass.footer.description', 'Your trusted partner for affordable and reliable eSIM travel packages worldwide.')}
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} TravelPass. {getText(t, 'travelpass.footer.rights', 'All rights reserved.')}
          </p>

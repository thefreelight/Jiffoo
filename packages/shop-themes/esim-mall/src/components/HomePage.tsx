    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-xl text-white">
            ...
            <p className="text-xl mb-6">
              {getText(
                ...
                `Get affordable eSIM travel packages from ${brandName} for 190+ countries. No contracts, instant activation.`
              )}
            </p>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-2">
              {getText(
                ...
                `Explore ${brandName}'s most popular eSIM travel packages`
              )}
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800">
              {getText('travelpass.home.whyChoose.title', `Why Choose ${brandName}`)}
            </h2>
            <p className="text-gray-600 mt-2">
              {getText(
                'travelpass.home.whyChoose.subtitle',
                `${brandName} makes staying connected while traveling simple and affordable`
              )}
            </p>
          </div>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-2">
              {getText(
                ...
                `Thousands of travelers trust ${brandName} for their connectivity needs`
              )}
            </p>
          </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                {getText(
                  ...
                  `"I used ${brandName} for my trip to Europe and it worked flawlessly. The setup was incredibly easy and the connection was fast and reliable throughout my journey."`
                )}
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                {getText(
                  ...
                  `"As a frequent traveler, I've tried many international SIM options. ${brandName} eSIM is by far the most convenient. No more hunting for local SIMs at airports!"`
                )}
              </p>
            </div>
        ...
        <div className="container mx-auto text-center px-4">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            {getText(
              ...
              `Get connected with ${brandName} eSIM and enjoy hassle-free internet access worldwide.`
            )}
          </p>

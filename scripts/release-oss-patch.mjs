...
function collectPublishFiles() {
  return [
    ...
    'apps/admin/components/extensions',
    'apps/admin/components/layout',
    'apps/admin/lib/admin-access.ts',
    'apps/admin/lib/api.ts',
    'apps/admin/lib/hooks/use-api.ts',
    'apps/admin/lib/store.ts',
    'apps/api/prisma',
    'apps/api/scripts/build-official-artifacts.ts',
    'apps/api/src/core/admin/extension-installer/security.ts',
    'apps/api/src/core/admin/market/market-client.ts',
    'apps/api/src/core/admin/market/official-catalog.ts',
    'apps/api/src/core/admin/market/install-handoff.ts',
    'apps/api/src/core/admin/market/resumable-downloader.ts',
    'apps/api/src/core/admin/staff-management',
    'apps/api/src/core/auth/admin-access.ts',
    'apps/api/src/core/auth/admin-membership-compat.ts',
    'apps/api/src/core/auth/admin-permission-guard.ts',
    'apps/api/src/core/auth/middleware.ts',
    'apps/api/src/core/auth/routes.ts',
    'apps/api/src/core/auth/schemas.ts',
    'apps/api/src/core/auth/service-auth.ts',
    ...
    'apps/api/tests',
    'apps/shop/app/[locale]/auth/accept-invite',
    'apps/shop/app/[locale]/auth/verify-email',
    'apps/shop/components/store-context-provider.tsx',
    'apps/shop/lib/api.ts',
    'apps/shop/lib/themes',
    'apps/shop/tests/themes',
    'install.sh',
    '.env.production.example',
    'packages/shared/api/auth-client.ts',
    'packages/shared/api/client.ts',
    'packages/shared/src/security/admin-rbac.ts',
    'packages/shared/src/types/user.ts',
    'packages/shop-themes',
    'scripts/verify-theme-client-contracts.mjs',
  ];
}

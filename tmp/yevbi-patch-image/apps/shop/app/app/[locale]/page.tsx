...
import { getEmbeddedRendererSlug, isOfficialEmbeddedActiveTheme } from '@/lib/theme-pack/rendering-mode';
...
export default function HomePage() {
  ...
  const usesFullThemeRenderer = Boolean(embeddedRendererSlug) || isOfficialEmbeddedActiveTheme(themePack?.activeTheme ?? null);

...
import '@shop-themes/esim-mall/src/tokens.css';
...
export default async function RootLayout({
  ...
  const themeConfig = resolveThemeConfig(context);
  const shouldShowPwaInstallBanner =
    context?.theme?.slug !== 'imagic-studio' && themeConfig?.site?.archetype !== 'product-site';
    ...
    <html lang="en" suppressHydrationWarning>
      <body className="font-sans antialiased">
        ...
        */}
        ...
        {shouldShowPwaInstallBanner ? <PwaInstallBanner /> : null}

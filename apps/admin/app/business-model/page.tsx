...
export default function BusinessModelPage() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Jiffoo Mall Business Model</h1>
        <p className="text-lg text-gray-600 max-w-3xl">
          Open source core with commercial plugins and SaaS services. 
          Start free, scale with your business needs.
        </p>
      </div>
      ...
      <Tabs defaultValue="pricing" className="space-y-8">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="plugins">Plugin Comparison</TabsTrigger>
          <TabsTrigger value="saas">SaaS Services</TabsTrigger>
                ...
                >
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      >
                        {plan.id === 'open-source' ? 'Get Started Free' : 'Start Trial'}
                      </Button>
                    </div>
                  </CardContent>
                </Card>
        ...
        <TabsContent value="plugins" className="space-y-6">
          <div className="bg-white rounded-lg border">
            <div className="px-6 py-4 border-b">
              <h3 className="text-lg font-semibold">Plugin Feature Comparison</h3>
              <p className="text-gray-600">See what's included in open source vs commercial versions</p>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-gray-50">
                    ...
                    <th className="text-left p-4 font-medium">Open Source</th>
                    <th className="text-left p-4 font-medium">Commercial</th>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-medium">Phase 1: Open Source Foundation (Completed)</h4>
                    <p className="text-gray-600">Core e-commerce functionality, plugin system, demo plugins</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-medium">Phase 2: Commercial Plugins (In Progress)</h4>
                    <p className="text-gray-600">Payment gateways, authentication providers, marketing tools</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-medium">Phase 3: SaaS Services (Q2 2024)</h4>
                    <p className="text-gray-600">Cloud-based services, AI features, advanced analytics</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-medium">Phase 4: Enterprise Features (Q3 2024)</h4>
                    <p className="text-gray-600">Multi-tenant, white-label, enterprise security</p>
                  </div>
                </div>
              </div>
            </div>

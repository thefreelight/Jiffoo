...
import { ArrowLeft, Mail, Settings as Cog6ToothIcon } from 'lucide-react'
      ...
      <Card>
        <CardHeader>
          <div className="flex items-start gap-4">
            <div className="p-3 bg-red-100 rounded-lg"><Mail className="w-8 h-8 text-red-600" /></div>
            <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative mt-1">
                <Input type={apiKeyVisible ? 'text' : 'password'} value={apiKey} onChange={(e) => setApiKey(e.target.value)} placeholder="re_..." />
                <Button variant="ghost" size="sm" className="absolute right-0 top-0" onClick={() => setApiKeyVisible(!apiKeyVisible)}>
            ...
            <div>
              ...
              <Input className="mt-1" value={fromEmail} onChange={(e) => setFromEmail(e.target.value)} placeholder="onboarding@resend.dev" />
            </div>
          </div>

 ...
 *
 * Manage 301/302 redirects for SEO purposes.
 * Displays redirect list with search, add/edit/delete operations, and pagination.
...
export default function RedirectsPage() {
  ...
  const navItems = [
    { label: getText('admin.seo.overview', 'SEO Overview'), href: '/seo', exact: true },
    { label: getText('admin.seo.redirects', 'Redirects'), href: '/seo/redirects' },
    { label: getText('admin.seo.audit', 'SEO Audit'), href: '/seo/audit' },
  ]
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{getText('admin.seo.redirectsTitle', 'SEO Redirects')}</h1>
            <p className="text-gray-600 mt-1">{getText('admin.seo.redirectsSubtitle', 'Manage 301/302 redirects for SEO')}</p>
          </div>

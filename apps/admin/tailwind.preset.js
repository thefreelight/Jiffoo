...
module.exports = {
  theme: {
    extend: {
      colors: {
        jf: { primary: '#3B82F6', 'primary-hover': '#2563EB', 'primary-light': '#EFF6FF', 'bg-main': '#F8FAFC', 'bg-card': '#FFFFFF', 'text-main': '#0F172A', 'text-muted': '#64748B', border: '#E2E8F0' },
        admin: { 'bg-body': '#F1F5F9', 'bg-card': '#FFFFFF', 'bg-sidebar': '#FFFFFF', primary: '#3B82F6', 'primary-light': '#EFF6FF', 'primary-hover': '#2563EB', 'text-main': '#0F172A', 'text-muted': '#64748B', border: '#E2E8F0', 'success-bg': '#DCFCE7', 'success-text': '#166534', 'warning-bg': '#FEF9C3', 'warning-text': '#854D0E', 'error-bg': '#FEE2E2', 'error-text': '#991B1B' },
        ...
        error: { 50: '#FEE2E2', 100: '#FECACA', 500: '#EF4444', 600: '#DC2626', 700: '#B91C1C' },
        info: { 50: '#DBEAFE', 100: '#BFDBFE', 500: '#3B82F6', 600: '#2563EB', 700: '#1D4ED8' },
      },
      ...
      width: { sidebar: '260px' },
      height: { header: '70px' },
      borderRadius: { none: '0', sm: '4px', DEFAULT: '6px', md: '8px', lg: '12px', xl: '16px', '2xl': '24px', '3xl': '32px', full: '9999px' },
      boxShadow: { sm: '0 1px 2px 0 rgb(0 0 0 / 0.05)', DEFAULT: '0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)', md: '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)', lg: '0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)', xl: '0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)', '2xl': '0 25px 50px -12px rgb(0 0 0 / 0.25)', 'brand-sm': '0 4px 14px -3px rgba(37, 99, 235, 0.15)', 'brand-md': '0 10px 30px -10px rgba(37, 99, 235, 0.3)', 'brand-lg': '0 20px 40px -10px rgba(37, 99, 235, 0.4)', 'jf-button': '0 4px 14px -4px rgba(59, 130, 246, 0.5)', 'jf-button-hover': '0 6px 20px -4px rgba(59, 130, 246, 0.6)', 'jf-card': '0 25px 50px -12px rgba(59, 130, 246, 0.15)' },

/**
 * Admin Global Error Boundary Component
 *
 * Catches and handles React errors in the admin application.
 * Note: Class components cannot use hooks, so i18n is handled via props or context.
 */

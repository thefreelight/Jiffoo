...
describe('Admin Plugins Endpoints', () => {
  ...
  describe('GET /api/v1/admin/plugins/categories', () => {
    it('should return plugin categories for admin (or 404 if not implemented)', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/admin/plugins/categories',
        headers: { authorization: `Bearer ${adminToken}` },
      });
  ...
  describe('GET /api/v1/admin/plugins/installed', () => {
    it('should return installed plugins for admin (or 404 if not implemented)', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/admin/plugins/installed',
        headers: { authorization: `Bearer ${adminToken}` },
      });
  ...
  describe('POST /api/v1/admin/plugins/:slug/install', () => {
    it('should return 401 without token (or 404 if route not implemented)', async () => {
      const response = await app.inject({
        method: 'POST',
        url: '/api/v1/admin/plugins/test-plugin/install',
      });
  ...
  describe('GET /api/v1/admin/plugins/:slug', () => {
    it('should return 401 without token (or 404 if route not implemented)', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/api/v1/admin/plugins/test-plugin',
      });
  ...
  describe('POST /api/v1/admin/plugins/:slug/enable', () => {
    it('should return 401 without token (or 404 if route not implemented)', async () => {
      const response = await app.inject({
        method: 'POST',
        url: '/api/v1/admin/plugins/test-plugin/enable',
      });
  ...
  describe('POST /api/v1/admin/plugins/:slug/disable', () => {
    it('should return 401 without token (or 404 if route not implemented)', async () => {
      const response = await app.inject({
        method: 'POST',
        url: '/api/v1/admin/plugins/test-plugin/disable',
      });
  ...
  describe('PUT /api/v1/admin/plugins/:slug/config', () => {
    it('should return 401 without token (or 404 if route not implemented)', async () => {
      const response = await app.inject({
        method: 'PUT',
        url: '/api/v1/admin/plugins/test-plugin/config',

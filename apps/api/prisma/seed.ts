    ...
    const sampleProducts: Array<{
      ...
      extraVariants?: Array<{
    ...
    }> = [
        {
          ...
          zhName: 'Wireless Bluetooth Headphones (Trad. Chinese)',
          zhDescription: 'High-end noise-cancelling wireless headphones, up to 30 hours battery life (Trad. Chinese)',
        ...
        },
        {
          ...
          zhName: 'Smart Watch Pro (Trad. Chinese)',
          zhDescription: 'Advanced sports tracking watch with heart rate monitoring and GPS (Trad. Chinese)',
          categoryId: 'cat-electronics',
        ...
        },
        {
          ...
          zhName: 'Classic Cotton T-Shirt (Trad. Chinese)',
          zhDescription: '100% organic cotton, comfortable and breathable, multiple colors available (Trad. Chinese)',
        ...
        },
        {
          ...
          zhName: 'Minimalist Desk Lamp (Trad. Chinese)',
          zhDescription: 'LED desk lamp, supports brightness and color temperature adjustment (Trad. Chinese)',
          categoryId: 'cat-home',
        ...
        },
        {
          ...
          zhName: 'Natural Skincare Set (Trad. Chinese)',
          zhDescription: 'Cleanser + Toner + Cream, complete skincare routine (Trad. Chinese)',
        ...
        },
        {
          ...
          zhName: 'Eco-friendly Thick Yoga Mat (Trad. Chinese)',
          zhDescription: 'Thick non-slip mat with carrying strap, suitable for home training (Trad. Chinese)',

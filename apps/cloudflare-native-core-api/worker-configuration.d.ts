/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 36ab4afd06bb914b7ac404cc64f178cd)
// Runtime types generated with workerd@1.20260708.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	...
	PLUGIN_CONFIG_KEY: SecretsStoreSecret;
	SNAPSHOT_IMPORT_TOKEN: SecretsStoreSecret;
	AI: Ai;
	CORE_ORIGIN: "https://replace-with-instance-origin.example.com";
	JOBS_SERVICE_URL: "https://replace-with-instance-jobs.example.com";
	NATIVE_CHECKOUT_ENABLED: "false";
	REMOTERADAR_AI_MODEL: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORE_ORIGIN" | "JOBS_SERVICE_URL" | "NATIVE_CHECKOUT_ENABLED" | "REMOTERADAR_AI_MODEL" | "RUNTIME_VERSION">> {}
}

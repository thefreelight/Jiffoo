...
export default function NewArrivalsPage() {
  ...
  if (!theme?.components?.NewArrivalsPage) {
    return (
      <ErrorState
        ...
        message={getText('common.errors.componentUnavailable', 'Unable to load new arrivals page component')}
        onGoHome={() => nav.push('/')}
        fullPage
      />
    );
  ...
  return <TemplateRenderer page="new-arrivals" fallback={defaultNewArrivalsPage} />;
}
